...
export class PersonEdit {
  ...
  async submit() {
    ...
    // Anna Lycett:
    // I believe this could be achieved by using Angular or
    // perhaps some other approach but unfortunately this is 
    // currently outside of my scope of knowledge and I have
    // been unable to find a solution to this task.
